...
import { Box, Button, Chip, Divider, IconButton, List, ListItem } from "@mui/material";
                ...
                <List dense>
                    {buddys.map((buddy, index) => (
                        <React.Fragment key={buddy.id}>
                            {index !== 0 && <Divider sx={{ width: "100%", mb: 1 }} />}
                            <ListItem key={buddy.id} sx={{ flexDirection: "column", alignItems: "flex-start", mb: 1 }}>
